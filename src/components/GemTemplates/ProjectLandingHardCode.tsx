...
import logoToshiba from '../../../public/logos/toshiba-leading-innovation.svg'
// import logoHitachi from '../../../public/logos/Hitachi_logo_PNG5.png'
...
export default function ProjectLandingHardCode({ markdown, image }: IProps) {
	// const imgSrc = require(`../../../public/images/${image}`)

	return (
		<>
			<div className='mb-6 text-center text-2xl font-bold md:mb-12'>
